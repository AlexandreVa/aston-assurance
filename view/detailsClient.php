...
<ul>
  ...
  <li>
    ...
    <input type="text" name="LifeInsurance" value="<?php echo $client->getAdress1(); ?>" />
  </li>
  <li>
    <label for="clientAdress2">Assurance décès</label>
    <input type="text" name="DeadInsurance" value="<?php echo $client->getAdress2(); ?>" />
  </li>
  </div>
  <div>
  </li>
